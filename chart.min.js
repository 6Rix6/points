...
!function t(e, i, a) {
    ...
    3: [function(t, e, i) {
        ...
        n.prototype = {
            ...
            clone: function() {
                ...
                for (var r in a)
                    a.hasOwnProperty(r) && (t = a[r],
                    e = {}.toString.call(t),
                    "[object Array]" === e ? o[r] = t.slice(0) : "[object Number]" === e ? o[r] = t : console.error("unexpected color value:", t));
                return i
            }
        },
        n.prototype.spaces = {
        ...
        n.prototype.setValues = function(t, e) {
            ...
            if (o.alpha = Math.max(0, Math.min(1, void 0 === s ? o.alpha : s)),
            "alpha" === t)
                return !1;
            var h;
            for (i = 0; i < t.length; i++)
        ...
        n.prototype.setChannel = function(t, e, i) {
            var a = this.values[t];
            return void 0 === i ? a[e] : i === a[e] ? this : (a[e] = i,
            this.setValues(t, a),
            this)
        }
        ,
    ...
    4: [function(t, e, i) {
        ...
        function L(t) {
            ...
            return 8 >= n ? (i = 100 * n / 903.3,
            o = 7.787 * (i / 100) + 16 / 116) : (i = 100 * Math.pow((n + 16) / 116, 3),
        ...
        e.exports = function(t) {
            ...
            i.doughnut = {
                ...
                legend: {
                    ...
                    onClick: function(t, e) {
                        ...
                        for (i = 0,
                        a = (r.data.datasets || []).length; a > i; ++i)
            ...
            t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                ...
                updateElement: function(t, i, a) {
                    ...
                    a && l.animateRotate || (0 === i ? y.startAngle = s.rotation : y.startAngle = o.getMeta().data[i - 1]._model.endAngle,
        ...
        e.exports = function(t) {
            ...
            t.controllers.line = t.DatasetController.extend({
                ...
                update: function(t) {
                    ...
                    for (d.showLines && (o = r.getDataset(),
                    n = l.custom || {},
                ...
                draw: function(t) {
                    ...
                    i = o.length; i > e; ++e)
                        o[e].transition(n);
                    for (this.chart.options.showLines && a.dataset.transition(n).draw(),
                    e = 0,
                    i = o.length; i > e; ++e)
                        o[e].draw()
                },
        ...
        e.exports = function(t) {
            ...
            t.animationService = {
                ...
                cancelAnimation: function(t) {
                    ...
                    -1 !== i && (this.animations.splice(i, 1),
                    t.animating = !1)
                },
                ...
                startDigest: function() {
                    ...
                    for (var i = 0; i < this.animations.length; )
                        ...
                        this.animations[i].animationObject.currentStep === this.animations[i].animationObject.numSteps ? (this.animations[i].animationObject.onAnimationComplete && this.animations[i].animationObject.onAnimationComplete.call && this.animations[i].animationObject.onAnimationComplete.call(this.animations[i].chartInstance, this.animations[i]),
        ...
        e.exports = function(t) {
            ...
            e.extend(t.Controller.prototype, {
                ...
                resize: function(t) {
                    ...
                    return n ? (i.width = this.chart.width = a,
                ...
                buildOrUpdateControllers: function() {
                    ...
                    if (e.each(this.data.datasets, function(e, o) {
                        ...
                        i.push(n.type),
                        n.controller ? n.controller.updateIndex(o) : (n.controller = new t.controllers[n.type](this,o),
                        a.push(n.controller))
                    }, this),
                    i.length > 1)
                    ...
                    return e.each(this.data.datasets, function(t, o) {
                        if (this.isDatasetVisible(o)) {
                            ...
                            e.each(n.data, function(t, e) {
                                return t.inRange(i.x, i.y) ? (a.push(t),
                                a) : void 0
                            })
                        }
                    }, this),
                ...
                eventHandler: function(t) {
                    ...
                    i.tooltipActive = []) : (i.active = i.getElementsAtEventForMode(t, n.mode),
                    i.tooltipActive = i.getElementsAtEventForMode(t, r.mode)),
                    n.onHover && n.onHover.call(i, i.active),
                    ("mouseup" === t.type || "click" === t.type) && (o.onClick && o.onClick.call(i, t, i.active),
                    ...
                    (r.enabled || r.custom) && (a.initialize(),
                    a._active = i.tooltipActive,
                    a.update(!0)),
                    a.pivot(),
                    i.animating || e.arrayEquals(i.active, i.lastActive) && e.arrayEquals(i.tooltipActive, i.lastTooltipActive) || (i.stop(),
        ...
        e.exports = function(t) {
            ...
            e.extend(t.Element.prototype, {
                ...
                transition: function(t) {
                    return this._view || (this._view = e.clone(this._model)),
                    1 === t ? (this._view = this._model,
                    this._start = null,
                    this) : (this._start || this.pivot(),
                    e.each(this._model, function(i, a) {
                        if ("_" === a[0])
                            ;
                            ...
                            "number" != typeof i || isNaN(this._view[a]) ? this._view[a] = i : this._view[a] = i * t
                    }, this),
                    this)
                },
    ...
    25: [function(t, e, i) {
        ...
        e.exports = function(t) {
                ...
                return n.each(Array.prototype.slice.call(arguments, 1), function(e) {
                    n.each(e, function(e, a) {
                        if ("scales" === a)
                            ...
                            i.hasOwnProperty(a) && "object" == typeof i[a] && null !== i[a] && "object" == typeof e ? i[a] = n.configMerge(i[a], e) : i[a] = e
                    })
                }),
                i
            }
            ...
            ,
            n.sign = function(t) {
                return Math.sign ? Math.sign(t) : (t = +t,
            ...
            var r = n.easingEffects = {
                ...
                easeInElastic: function(t) {
                    ...
                    a < Math.abs(1) ? (a = 1,
                    e = i / 4) : e = i / (2 * Math.PI) * Math.asin(1 / a),
                ...
                easeInOutElastic: function(t) {
                    ...
                    a < Math.abs(1) ? (a = 1,
                    e = i / 4) : e = i / (2 * Math.PI) * Math.asin(1 / a),
                    1 > t ? -.5 * (a * Math.pow(2, 10 * (t -= 1)) * Math.sin((1 * t - e) * (2 * Math.PI) / i)) : a * Math.pow(2, -10 * (t -= 1)) * Math.sin((1 * t - e) * (2 * Math.PI) / i) * .5 + 1)
                },
            ...
            ,
            n.color = function(e) {
                return a ? a(e instanceof CanvasGradient ? t.defaults.global.defaultColor : e) : (console.log("Color.js not found!"),
                e)
            }
            ,
            ...
            t.layoutService = {
                ...
                update: function(t, i, a) {
                    function o(t) {
                        ...
                        i ? (e = t.update(t.options.fullWidth ? p : k, y),
                    ...
                    function s(t) {
                        t.isHorizontal() ? (t.left = t.options.fullWidth ? l : w,
            ...
            t.Legend = t.Element.extend({
                ...
                fit: function() {
                    var i = this.options
                      ...
                      , f = this.minSize
                      , g = this.isHorizontal();
                    if (g ? (f.width = this.maxWidth,
                    f.height = o ? 10 : 0) : (f.width = o ? 10 : 0,
                    ...
                    o && g) {
                        ...
                        e.each(this.legendItems, function(t, e) {
                            ...
                            p[p.length - 1] + i + a.padding >= this.width && (m += l + a.padding,
        ...
        e.exports = function(t) {
            ...
            t.Scale = t.Element.extend({
                ...
                calculateTickRotation: function() {
                    ...
                    if (this.labelRotation = o.minRotation || 0,
                    this.paddingRight = 0,
                    this.paddingLeft = 0,
                    this.options.display && this.isHorizontal()) {
                        ...
                        for (var u, f, g = e.longestText(i, l, this.ticks, this.longestTextCache), p = g, m = this.getPixelForTick(1) - this.getPixelForTick(0) - 6; p > m && this.labelRotation < o.maxRotation; ) {
                            if (u = Math.cos(e.toRadians(this.labelRotation)),
                    ...
                    this.margins && (this.paddingLeft = Math.max(this.paddingLeft - this.margins.left, 0),
                ...
                fit: function() {
                    ...
                    if (l ? i.width = this.isFullWidth() ? this.maxWidth - this.margins.left - this.margins.right : this.maxWidth : i.width = s ? m : 0,
                ...
                draw: function(i) {
                    ...
                    if (a.display) {
                        ...
                        this.isHorizontal()) {
                            ...
                            if (n = !1,
                            g && (F /= 2),
                            (F + c.autoSkipPadding) * this.ticks.length > this.width - (this.paddingLeft + this.paddingRight) && (n = 1 + Math.floor((F + c.autoSkipPadding) * this.ticks.length / (this.width - (this.paddingLeft + this.paddingRight)))),
                            l && this.ticks.length > l)
                                for (; !n || this.ticks.length / (n || 1) > l; )
                                    n || (n = 1),
                                    n += 1;
                            p || (n = !1),
                            e.each(this.ticks, function(t, r) {
                                ...
                                if ((!l || s) && void 0 !== t && null !== t) {
                                    ...
                                    u.display && (r === ("undefined" != typeof this.zeroLineIndex ? this.zeroLineIndex : 0) ? (h.lineWidth = u.zeroLineWidth,
                                    h.strokeStyle = u.zeroLineColor,
                                    o = !0) : o && (h.lineWidth = u.lineWidth,
                                    h.strokeStyle = u.color,
                                    o = !1),
                                    d += e.aliasPixel(h.lineWidth),
                                    h.beginPath(),
                                    u.drawTicks && (h.moveTo(d, _),
                                    h.lineTo(d, P)),
                                    u.drawOnChartArea && (h.moveTo(d, i.top),
                                    h.lineTo(d, i.bottom)),
                                    h.stroke()),
                                    c.display && (h.save(),
                            ...
                            if (e.each(this.ticks, function(t, n) {
                                if (void 0 !== t && null !== t) {
                                    ...
                                    if (u.display && (n === ("undefined" != typeof this.zeroLineIndex ? this.zeroLineIndex : 0) ? (h.lineWidth = u.zeroLineWidth,
                                    h.strokeStyle = u.zeroLineColor,
                                    o = !0) : o && (h.lineWidth = u.lineWidth,
                                    h.strokeStyle = u.color,
                                    o = !1),
                                    ...
                                    h.beginPath(),
                                    u.drawTicks && (h.moveTo(T, r),
                                    h.lineTo(V, r)),
                                    u.drawOnChartArea && (h.moveTo(i.left, r),
                                    h.lineTo(i.right, r)),
                                    h.stroke()),
                                    c.display) {
                                        var s, l = this.getPixelForTick(n, u.offsetGridLines);
                                        h.save(),
                                        "left" === a.position ? c.mirror ? (s = this.right + c.padding,
                                        h.textAlign = "left") : (s = this.right - c.padding,
                                        h.textAlign = "right") : c.mirror ? (s = this.left - c.padding,
                                        h.textAlign = "right") : (s = this.left + c.padding,
                                        h.textAlign = "left"),
                        ...
                        if (u.drawBorder) {
                            ...
                            this.isHorizontal() ? (L = B = "top" === a.position ? this.bottom : this.top,
                            L += z,
                            B += z) : (O = W = "left" === a.position ? this.right : this.left,
                            O += z,
                            W += z),
                            h.beginPath(),
                            h.moveTo(O, L),
            ...
            t.Title = t.Element.extend({
                ...
                fit: function() {
                    ...
                    e.getValueOrDefault)
                      ...
                      , l = i.minSize;
                    i.isHorizontal() ? (l.width = i.maxWidth,
                    l.height = r ? s + 2 * o.padding : 0) : (l.width = r ? s + 2 * o.padding : 0,
                ...
                draw: function() {
                    ...
                    if (n.display) {
                        ...
                        a.font = u,
                        i.isHorizontal() ? (s = p + (b - p) / 2,
                        l = g + (m - g) / 2) : (s = "left" === n.position ? p + h / 2 : b - h / 2,
                        l = g + (m - g) / 2,
        ...
        e.exports = function(t) {
            ...
            t.Tooltip = t.Element.extend({
                ...
                determineAlignment: function(t) {
                    ...
                    ,
                    e(this._model.x) ? (this._model.xAlign = "left",
                    a(this._model.x) && (this._model.xAlign = "center",
                    this._model.yAlign = n(this._model.y))) : i(this._model.x) && (this._model.xAlign = "right",
                    o(this._model.x) && (this._model.xAlign = "center",
                ...
                drawCaret: function(t, e, a, o) {
                    ...
                    "center" === c.yAlign ? ("left" === c.xAlign ? (n = t.x,
                    r = n - c.caretSize,
                    s = n) : (n = t.x + e.width,
                    r = n + c.caretSize,
                    s = n),
                    h = t.y + e.height / 2,
                    l = h - c.caretSize,
                    d = h + c.caretSize) : ("left" === c.xAlign ? (n = t.x + c.cornerRadius,
                    r = n + c.caretSize,
                    s = r + c.caretSize) : "right" === c.xAlign ? (n = t.x + e.width - c.cornerRadius,
                    r = n - c.caretSize,
                    s = r - c.caretSize) : (r = t.x + e.width / 2,
                    n = r - c.caretSize,
                    s = r + c.caretSize),
                    "top" === c.yAlign ? (l = t.y,
                    h = l - c.caretSize,
                ...
                drawBody: function(t, e, a, o) {
                    ...
                    i.each(e.body, function(n, r) {
                        "single" !== this._options.tooltips.mode && (a.fillStyle = i.color(e.legendColorBackground).alpha(o).rgbaString(),
        ...
        e.exports = function(t) {
            ...
            t.elements.Line = t.Element.extend({
                ...
                draw: function() {
                    ...
                    n.save(),
                    this._children.length > 0 && o.fill && (n.beginPath(),
                    e.each(this._children, function(t, i) {
                        var a = e.previousItem(this._children, i)
                          , r = e.nextItem(this._children, i);
                        0 === i ? (this._loop ? n.moveTo(o.scaleZero.x, o.scaleZero.y) : n.moveTo(t._view.x, o.scaleZero),
                        t._view.skip ? this._loop || n.moveTo(r._view.x, this._view.scaleZero) : n.lineTo(t._view.x, t._view.y)) : this.lineToNextPoint(a, t, r, function(t, e, i) {
                            this._loop ? n.lineTo(this._view.scaleZero.x, this._view.scaleZero.y) : (n.lineTo(t._view.x, this._view.scaleZero),
                            n.moveTo(i._view.x, this._view.scaleZero))
                        }, function(t, e) {
                            n.lineTo(e._view.x, e._view.y)
                        })
                    }, this),
                    this._loop ? t(!0) : (n.lineTo(this._children[this._children.length - 1]._view.x, o.scaleZero),
            ...
            t.elements.Point = t.Element.extend({
                ...
                draw: function() {
                    ...
                    if (!h.skip) {
                        ...
                        if (!(isNaN(u) || 0 >= u)) {
                            switch (d.strokeStyle = h.borderColor || a,
            ...
            var e = t.helpers
              ...
              , a = t.Scale.extend({
                determineDataLimits: function() {
                    ...
                    var t;
                    void 0 !== this.options.ticks.min && (t = e.indexOf(this.chart.data.labels, this.options.ticks.min),
                    this.minIndex = -1 !== t ? t : this.minIndex),
                    void 0 !== this.options.ticks.max && (t = e.indexOf(this.chart.data.labels, this.options.ticks.max),
            ...
            var e = t.helpers
              ...
              , a = t.Scale.extend({
                    ...
                    a.stacked) {
                        ...
                        e.each(s, function(o, r) {
                            ...
                            n.isDatasetVisible(r) && t(s) && e.each(o.data, function(t, e) {
                                ...
                                isNaN(o) || s.data[e].hidden || (l[e] = l[e] || 0,
                                u[e] = u[e] || 0,
                                a.relativePoints ? l[e] = 100 : 0 > o ? (c = !0,
                                u[e] += o) : (d = !0,
                                l[e] += o))
                            })
                        }),
                        ...
                        e.each(s, function(a, o) {
                            ...
                            n.isDatasetVisible(o) && t(r) && e.each(a.data, function(t, e) {
                                ...
                                isNaN(a) || r.data[e].hidden || (null === i.min ? i.min = a : a < i.min && (i.min = a),
                ...
                buildTicks: function() {
                    ...
                    if (c)
                        d = r(n.fixedStepSize, n.stepSize);
                    else {
                ...
                getPixelForValue: function(t, e, i, a) {
                    ...
                    return r.isHorizontal() ? (n = r.width - (s + r.paddingRight),
                    o = r.left + n / c * (d - h),
                    Math.round(o + s)) : (n = r.height - (r.paddingTop + l),
              ...
              , a = t.Scale.extend({
                determineDataLimits: function() {
                    ...
                    a.stacked) {
                        ...
                        e.each(s, function(o, r) {
                            var s = n.getDatasetMeta(r);
                            n.isDatasetVisible(r) && t(s) && (void 0 === d[s.type] && (d[s.type] = []),
                            e.each(o.data, function(t, e) {
                                var o = d[s.type]
                                  , n = +i.getRightValue(t);
                                isNaN(n) || s.data[e].hidden || (o[e] = o[e] || 0,
                    ...
                    i.min = l(o.min, i.min),
                    i.max = l(o.max, i.max),
                    i.min === i.max && (0 !== i.min && null !== i.min ? (i.min = Math.pow(10, Math.floor(e.log10(i.min)) - 1),
                    i.max = Math.pow(10, Math.floor(e.log10(i.max)) + 1)) : (i.min = 1,
                    i.max = 10))
                },
                buildTicks: function() {
                ...
                getPixelForValue: function(t, i, a, o) {
                    ...
                    return s.isHorizontal() ? 0 === h ? r = s.left + f : (n = s.width - (f + s.paddingRight),
                    r = s.left + n / d * (e.log10(h) - e.log10(l)),
                    r += f) : 0 === h ? r = s.top + c : (n = s.height - (c + u),
                    r = s.bottom - u - n / d * (e.log10(h) - e.log10(l))),
                    r
                },
                getValueForPixel: function(t) {
                    var i, a, o = this, n = e.log10(o.end) - e.log10(o.start);
                    return o.isHorizontal() ? (a = o.width - (o.paddingLeft + o.paddingRight),
                    i = o.start * Math.pow(10, (t - o.left - o.paddingLeft) * n / a)) : (a = o.height - (o.paddingTop + o.paddingBottom),
            ...
            var e = t.helpers
              ...
              , o = t.Scale.extend({
                ...
                determineDataLimits: function() {
                    if (this.min = null,
                    this.max = null,
                    e.each(this.chart.data.datasets, function(t, i) {
                        if (this.chart.isDatasetVisible(i)) {
                            var a = this.chart.getDatasetMeta(i);
                            e.each(t.data, function(t, e) {
                                var i = +this.getRightValue(t);
                                isNaN(i) || a.data[e].hidden || (null === this.min ? this.min = i : i < this.min && (this.min = i),
                ...
                buildTicks: function() {
                    ...
                    this.options.ticks.reverse ? (this.ticks.reverse(),
                    this.start = this.max,
                ...
                fit: function() {
                    ...
                    for (this.ctx.font = v,
                    a = 0; a < this.getValueCount(); a++)
                        t = this.getPointPosition(a, x),
                        o = this.ctx.measureText(this.pointLabels[a] ? this.pointLabels[a] : "").width + 5,
                        0 === a || a === this.getValueCount() / 2 ? (n = o / 2,
                        t.x + n > y && (y = t.x + n,
                        r = a),
                        t.x - n < k && (k = t.x - n,
                        l = a)) : a < this.getValueCount() / 2 ? t.x + o > y && (y = t.x + o,
                        r = a) : a > this.getValueCount() / 2 && t.x - o < k && (k = t.x - o,
                        l = a);
                    d = k,
                        ...
                        if (e.each(this.ticks, function(a, o) {
                            if (o > 0 || this.options.reverse) {
                                ...
                                if (this.options.gridLines.display)
                                    if (t.strokeStyle = this.options.gridLines.color,
              ...
              , n = t.Scale.extend({
                ...
                determineDataLimits: function() {
                    ...
                    this.chart.data.labels && this.chart.data.labels.length > 0 ? (e.each(this.chart.data.labels, function(e, i) {
                        ...
                        a.isValid() && (this.options.time.round && a.startOf(this.options.time.round),
                        t.push(a))
                    }, this),
                    this.firstTick = a.min.call(this, t),
                    this.lastTick = a.max.call(this, t)) : (this.firstTick = null,
                    this.lastTick = null),
                    e.each(this.chart.data.datasets, function(i, o) {
                        var n = []
                        ...
                        "object" == typeof i.data[0] && null !== i.data[0] ? e.each(i.data, function(t, e) {
                            ...
                            i.isValid() && (this.options.time.round && i.startOf(this.options.time.round),
                            n.push(i),
                            r && (this.firstTick = null !== this.firstTick ? a.min(this.firstTick, i) : i,
                ...
                buildTicks: function(a) {
                    ...
                    var x;
                    if (this.options.time.min ? x = this.getMomentStartOf(this.firstTick) : (this.firstTick = this.getMomentStartOf(this.firstTick),
                    x = this.firstTick),
                    ...
                    e.each(this.chart.data.datasets, function(t, e) {
                    ...
                    (0 !== C || 0 === this.scaleSizeInUnits) && (this.options.time.max ? (this.ticks.push(this.lastTick.clone()),
                    this.scaleSizeInUnits = this.lastTick.diff(this.ticks[0], this.tickUnit, !0)) : (this.ticks.push(this.lastTick.clone()),
                    this.scaleSizeInUnits = this.lastTick.diff(this.firstTick, this.tickUnit, !0))),
                    this.ctx.restore()
                },
                getLabelForIndex: function(t, e) {
